//! Izzo (2014) Lambert numeric backend.
//!
//! ## Scientific scope
//! This module implements the raw-array numeric kernel for Lambert's two-point
//! boundary-value problem, including zero- and multi-revolution branches.
//!
//! ## Technical scope
//! The functions here are crate-private implementation details backing the
//! public typed API in [`crate::lambert`]. Inputs are raw kilometre arrays,
//! raw seconds, and raw `f64` gravitational parameters.
//!
//! ## References
...
/// Internal Lambert solution in raw km/s arrays.
#[derive(Debug, Clone, Copy)]
